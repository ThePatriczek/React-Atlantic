...
export var StyledTimelineCaption = styled(Link)(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  display: block;\n  margin: 0;\n  color: ", ";\n  font-size: ", ";\n\n  ", " {\n    color: ", ";\n  }\n"], ["\n  display: block;\n  margin: 0;\n  color: ", ";\n  font-size: ", ";\n\n  ", " {\n    color: ", ";\n  }\n"])), function (props) { return props.theme.color.text.beta; }, function (props) { return props.theme.font.size.sm; }, StyledText, function (props) { return props.theme.color.text.beta; });
export var StyledTimelineContainer = styled.div(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n  ", "\n"], ["\n  ",
    "\n"])), function (props) {
    return props.isMain && css(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n      flex: 1 1 0;\n    "], ["\n      flex: 1 1 0;\n    "])));
});
export var StyledTimelineButton = styled(PureButton)(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n  ", " {\n    height: auto;\n  }\n"], ["\n  ", " {\n    height: auto;\n  }\n"])), StyledIcon);
