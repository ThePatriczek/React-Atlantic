...
export var StyledSkeleton = styled.div(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  position: relative;\n  background-color: ", ";\n  margin: ", " 0px;\n  border-radius: 4px;\n\n  background: -webkit-gradient(\n    linear,\n    left top,\n    right top,\n    color-stop(25%, ", "),\n    color-stop(37%, ", "),\n    color-stop(63%, ", ")\n  );\n  background: linear-gradient(\n    90deg,\n    ", " 25%,\n    ", " 37%,\n    ", " 63%\n  );\n  background-size: 400% 100%;\n  -webkit-animation: shine 1.6s ease infinite;\n  animation: shine 1.6s ease infinite;\n\n  @keyframes shine {\n    0% {\n      background-position: 100% 50%;\n    }\n    100% {\n      background-position: 0 50%;\n    }\n  }\n\n  ", "\n  \n  ", "\n  \n  ", "\n  \n  ", "\n"], ["\n  position: relative;\n  background-color: ", ";\n  margin: ", " 0px;\n  border-radius: 4px;\n\n  background: -webkit-gradient(\n    linear,\n    left top,\n    right top,\n    color-stop(25%, ", "),\n    color-stop(37%, ", "),\n    color-stop(63%, ", ")\n  );\n  background: linear-gradient(\n    90deg,\n    ", " 25%,\n    ", " 37%,\n    ", " 63%\n  );\n  background-size: 400% 100%;\n  -webkit-animation: shine 1.6s ease infinite;\n  animation: shine 1.6s ease infinite;\n\n  @keyframes shine {\n    0% {\n      background-position: 100% 50%;\n    }\n    100% {\n      background-position: 0 50%;\n    }\n  }\n\n  ",
    ...
    "\n  \n  ",
    "\n  \n  ",
    "\n"])), function (props) { return props.theme.color.default; }, function (props) { return props.theme.margin.sm; }, function (props) { return props.theme.color.background.beta; }, function (props) { return props.theme.color.border; }, function (props) { return props.theme.color.background.beta; }, function (props) { return props.theme.color.background.beta; }, function (props) { return props.theme.color.border; }, function (props) { return props.theme.color.background.beta; }, function (props) {
    return props.size
        ? sizeFactory(props.size, props.theme)
        : css(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n          width: 100%;\n          height: 100%;\n        "], ["\n          width: 100%;\n          height: 100%;\n        "])));
}, function (props) {
    return props.width && css(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n      width: ", "px;\n    "], ["\n      width: ", "px;\n    "])), props.width);
}, function (props) {
