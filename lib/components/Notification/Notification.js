...
export var Notification = function (props) {
    var children = props.children, title = props.title, className = props.className, size = props.size, type = props.type, footer = props.footer;
    var onClick = useClick({ deps: [] }).onClick;
    var titleIcon;
    ...
    return (React.createElement(StyledNotificationContainer, { size: size, type: type, className: className },
        React.createElement(StyledNotificationTitleContainer, { type: type },
            ...
            React.createElement(StyledNotificationCloseButton, { onClick: onClick },
