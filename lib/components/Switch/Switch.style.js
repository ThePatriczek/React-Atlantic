...
var switchWidthSmall = '50px';
var switchColorOff = theme.color.text.alpha;
var switchBackgroundColorOff = theme.color.border;
var switchColorOn = theme.color.text.gamma;
...
export var StyledSwitcherTrue = styled.div(templateObject_25 || (templateObject_25 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex: 0 0 50%;\n  height: 100%;\n  line-height: 1;\n  user-select: none;\n  color: ", ";\n  background-color: ", ";\n  transition: background-color .3s ease, color .3s ease;\n\n  ", "\n  \n  ", "\n  \n  ", "\n  \n  ", "\n \n  ", "  \n  ", " \n  \n  ", "\n  \n  ", "\n  \n  ", "\n  \n  ", "\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex: 0 0 50%;\n  height: 100%;\n  line-height: 1;\n  user-select: none;\n  color: ", ";\n  background-color: ", ";\n  transition: background-color .3s ease, color .3s ease;\n\n  ",
    "\n  \n  ",
    "\n  \n  ",
    "\n  \n  ",
    "\n \n  ",
    ...
    "\n  \n  ",
    "\n  \n  ",
    "\n"])), switchColorOff, switchBackgroundColorOff, function (props) { return css(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n    padding-left: ", ";\n    justify-content: flex-start;\n  "], ["\n    padding-left: ", ";\n    justify-content: flex-start;\n  "])), props.theme.padding.md); }, function (props) {
    return props.isChecked && css(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n      color: ", ";\n      background-color: ", ";\n    "], ["\n      color: ", ";\n      background-color: ", ";\n    "])), switchColorOn, props.theme.color.primary.alpha);
}, function (props) {
    return props.htmlType === 'success' &&
        props.isChecked && css(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n      color: ", ";\n      background-color: ", ";\n    "], ["\n      color: ", ";\n      background-color: ", ";\n    "])), switchColorOn, props.theme.color.success.alpha);
}, function (props) {
    return props.htmlType === 'warning' &&
        props.isChecked && css(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n      color: ", ";\n      background-color: ", ";\n    "], ["\n      color: ", ";\n      background-color: ", ";\n    "])), switchColorOn, props.theme.color.warning.alpha);
}, function (props) {
    return props.htmlType === 'error' &&
        props.isChecked && css(templateObject_15 || (templateObject_15 = __makeTemplateObject(["\n      color: ", ";\n      background-color: ", ";\n    "], ["\n      color: ", ";\n      background-color: ", ";\n    "])), switchColorOn, props.theme.color.error.alpha);
}, function (props) {
...
export var StyledSwitcherToggler = styled.div(templateObject_34 || (templateObject_34 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  right: ", "px;\n  bottom: 0;\n  width: ", "px;\n  margin: ", ";\n\n  background-color: ", ";\n  border-radius: 50%;\n  transition: right 0.3s ease;\n  \n  ", "\n  \n  ", "\n \n  ", "\n  \n   ", "\n   \n   ", "\n   \n   ", "\n   \n   ", "\n   ", "\n    "], ["\n  position: absolute;\n  top: 0;\n  right: ", "px;\n  bottom: 0;\n  width: ", "px;\n  margin: ", ";\n\n  background-color: ", ";\n  border-radius: 50%;\n  transition: right 0.3s ease;\n  \n  ",
    ...
    "\n   \n   ",
    "\n   ",
    "\n    "])), switchWidthNormalInt - togglerSizeNormalInt - 2 * marginSM, togglerSizeNormalInt, function (props) { return props.theme.margin.sm; }, function (props) { return props.theme.color.background.delta; }, function (props) {
    return props.isChecked && css(templateObject_26 || (templateObject_26 = __makeTemplateObject(["\n      right: ", ";\n    "], ["\n      right: ", ";\n    "])), switchWidthNormal);
}, function (props) {
    return props.isDisabled && css(templateObject_27 || (templateObject_27 = __makeTemplateObject(["\n      background-color: ", ";\n    "], ["\n      background-color: ", ";\n    "])), props.theme.color.background.delta);
}, function (props) {
    ...
    return props.size === 'small' &&
        props.isChecked && css(templateObject_29 || (templateObject_29 = __makeTemplateObject(["\n       right: ", ";\n     "], ["\n       right: ", ";\n     "])), switchWidthSmall);
}, function (props) {
    ...
    return props.size === 'large' &&
        props.isChecked && css(templateObject_31 || (templateObject_31 = __makeTemplateObject(["\n       right: ", ";\n     "], ["\n       right: ", ";\n     "])), switchWidthLarge);
}, function (props) {
    return props.size === 'medium' && css(templateObject_32 || (templateObject_32 = __makeTemplateObject(["\n       width: ", ";\n       right: ", "px;\n       font-size: 14px;\n     "], ["\n       width: ", ";\n       right: ", "px;\n       font-size: 14px;\n     "])), togglerSizeNormal, switchWidthNormalInt - togglerSizeNormalInt - 2 * marginSM);
}, function (props) {
    return props.size === 'medium' &&
        props.isChecked && css(templateObject_33 || (templateObject_33 = __makeTemplateObject(["\n       right: ", ";\n     "], ["\n       right: ", ";\n     "])), switchWidthNormal);
});
export var StyledSwitcherFalse = styled.div(templateObject_38 || (templateObject_38 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex: 0 0 50%;\n  height: 100%;\n  line-height: 1;\n\n  user-select: none;\n  color: ", ";\n  background-color: ", ";\n  transition: background-color 0.3s ease, color 0.3s ease;\n  ", "\n  \n  ", "\n   \n   ", "\n   \n \n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex: 0 0 50%;\n  height: 100%;\n  line-height: 1;\n\n  user-select: none;\n  color: ", ";\n  background-color: ", ";\n  transition: background-color 0.3s ease, color 0.3s ease;\n  ",
    "\n  \n  ",
    "\n   \n   ",
    "\n   \n \n"])), switchColorOff, switchBackgroundColorOff, function (props) {
    return props.isChecked && css(templateObject_35 || (templateObject_35 = __makeTemplateObject(["\n      color: ", ";\n    "], ["\n      color: ", ";\n    "])), switchColorOn);
}, function (props) {
    return props.isDisabled && css(templateObject_36 || (templateObject_36 = __makeTemplateObject(["\n      color: ", ";\n    "], ["\n      color: ", ";\n    "])), theme.color.text.gamma);
}, function (props) {
    return props.isDisabled &&
        props.htmlType && css(templateObject_37 || (templateObject_37 = __makeTemplateObject(["\n       color: ", ";\n     "], ["\n       color: ", ";\n     "])), theme.color.text.gamma);
});
