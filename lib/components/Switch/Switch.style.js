...
export var StyledSwitcherToggler = styled.div(templateObject_33 || (templateObject_33 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  right: ", "px;\n  bottom: 0;\n  width: ", "px;\n  margin: ", ";\n\n  background-color: white;\n  border-radius: 50%;\n  transition: right 0.3s ease;\n  ", "\n  ", "\n  \n   ", "\n   \n   ", "\n   ", "\n   \n   ", "\n   ", "\n"], ["\n  position: absolute;\n  top: 0;\n  right: ", "px;\n  bottom: 0;\n  width: ", "px;\n  margin: ", ";\n\n  background-color: white;\n  border-radius: 50%;\n  transition: right 0.3s ease;\n  ",
    ...
    return props.size === 'small' && css(templateObject_27 || (templateObject_27 = __makeTemplateObject(["\n      width: ", ";\n      right: ", "px;\n      font-size: 12px;\n    "], ["\n      width: ", ";\n      right: ",
    ...
    return props.size === 'medium' && css(templateObject_31 || (templateObject_31 = __makeTemplateObject(["\n       width: ", ";\n       right: ", "px;\n       font-size: 14px;\n     "], ["\n       width: ", ";\n       right: ", "px;\n       font-size: 14px;\n     "])), togglerSizeNormal, switchWidthNormalInt - togglerSizeNormalInt - 2 * marginSM);
}, function (props) {
    return props.size === 'medium' &&
        props.isChecked && css(templateObject_32 || (templateObject_32 = __makeTemplateObject(["\n       right: ", ";\n     "], ["\n       right: ", ";\n     "])), switchWidthNormal);
});
export var StyledSwitcherFalse = styled.div(templateObject_37 || (templateObject_37 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex: 0 0 50%;\n  height: 100%;\n  line-height: 1;\n\n  user-select: none;\n  color: ", ";\n  background-color: ", ";\n  transition: background-color 0.3s ease, color 0.3s ease;\n  ", "\n  ", "\n   \n   ", "\n   \n \n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex: 0 0 50%;\n  height: 100%;\n  line-height: 1;\n\n  user-select: none;\n  color: ", ";\n  background-color: ", ";\n  transition: background-color 0.3s ease, color 0.3s ease;\n  ",
    "\n  ",
    "\n   \n   ",
    "\n   \n \n"])), switchColorOff, darken(0.1, switchBackgroundColorOff), function (props) {
    return props.isChecked && css(templateObject_34 || (templateObject_34 = __makeTemplateObject(["\n      color: ", ";\n    "], ["\n      color: ", ";\n    "])), switchColorOn);
}, function (props) {
    return props.isDisabled && css(templateObject_35 || (templateObject_35 = __makeTemplateObject(["\n      background-color: ", ";\n      color: ", ";\n    "], ["\n      background-color: ", ";\n      color: ", ";\n    "])), lighten(0.2, switchBackgroundColorOff), theme.color.white);
}, function (props) {
    return props.isDisabled &&
        props.htmlType && css(templateObject_36 || (templateObject_36 = __makeTemplateObject(["\n       background-color: ", ";\n     "], ["\n       background-color: ", ";\n     "])), darken(0.1, switchBackgroundColorOff));
});
