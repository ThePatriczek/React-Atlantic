...
export var StyledSwitcherFalse = styled.div(templateObject_39 || (templateObject_39 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex: 0 0 50%;\n  height: 100%;\n  line-height: 1;\n\n  user-select: none;\n  color: ", ";\n  background-color: ", ";\n  transition: background-color 0.3s ease, color 0.3s ease;\n  ", "\n  \n  ", "\n   \n   ", "\n   \n \n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex: 0 0 50%;\n  height: 100%;\n  line-height: 1;\n\n  user-select: none;\n  color: ", ";\n  background-color: ", ";\n  transition: background-color 0.3s ease, color 0.3s ease;\n  ",
    "\n  \n  ",
    "\n   \n   ",
    "\n   \n \n"])), switchColorOff, darken(0.1, switchBackgroundColorOff), function (props) {
    return props.isChecked && css(templateObject_36 || (templateObject_36 = __makeTemplateObject(["\n      color: ", ";\n    "], ["\n      color: ", ";\n    "])), switchColorOn);
}, function (props) {
    return props.isDisabled && css(templateObject_37 || (templateObject_37 = __makeTemplateObject(["\n      color: ", ";\n    "], ["\n      color: ", ";\n    "])), theme.color.white);
}, function (props) {
    return props.isDisabled &&
        props.htmlType && css(templateObject_38 || (templateObject_38 = __makeTemplateObject(["\n       color: ", ";\n     "], ["\n       color: ", ";\n     "])), theme.color.white);
});
