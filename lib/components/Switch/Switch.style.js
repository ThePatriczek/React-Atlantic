...
export var StyledSwitchInputHidden = styled.input.attrs({ type: 'checkbox' })(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  opacity: 0;\n"], ["\n  opacity: 0;\n"])));
export var StyledSwitchLabel = styled.label(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  position: relative;\n  display: inline-block;\n  width: ", ";\n  height: ", ";\n  overflow: hidden;\n  cursor: pointer;\n  border-radius: ", ";\n  font-size: ", ";\n  font-family: ", ";\n  ", "\n  ", "\n  \n  ", "\n   ", "\n"], ["\n  position: relative;\n  display: inline-block;\n  width: ", ";\n  height: ", ";\n  overflow: hidden;\n  cursor: pointer;\n  border-radius: ", ";\n  font-size: ", ";\n  font-family: ", ";\n  ",
    "\n  ",
    "\n  \n  ",
    "\n   ",
...
export var StyledSwitcherWrap = styled.div(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  display: flex;\n  align-items: center;\n  width: 200%;\n  transition: right 0.3s ease;\n  \n  ", "\n  \n  ", "\n  \n  ", "\n  ", "\n"], ["\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  display: flex;\n  align-items: center;\n  width: 200%;\n  transition: right 0.3s ease;\n  \n  ",
    "\n  \n  ",
    "\n  \n  ",
    "\n  ",
    "\n"])), function (props) {
    return props.isChecked && css(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n      right: -", ";\n    "], ["\n      right: -", ";\n    "])), switchWidthNormal);
}, function (props) {
    ...
    return props.size === 'medium' &&
        props.isChecked && css(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n      right: -", ";\n    "], ["\n      right: -", ";\n    "])), switchWidthNormal);
});
export var StyledSwitcherTrue = styled.div(templateObject_24 || (templateObject_24 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex: 0 0 50%;\n  height: 100%;\n  line-height: 1;\n  user-select: none;\n  color: ", ";\n  background-color: ", ";\n  transition: background-color 0.3s ease, color 0.3s ease;\n\n  ", "\n  \n  ", "\n  \n  ", "\n  \n  ", "\n \n  ", "  \n  ", " \n  \n  ", "\n  \n  ", "\n  \n  ", "\n   \n   ", "\n   \n   ", "\n   \n  ", "\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex: 0 0 50%;\n  height: 100%;\n  line-height: 1;\n  user-select: none;\n  color: ", ";\n  background-color: ", ";\n  transition: background-color 0.3s ease, color 0.3s ease;\n\n  ",
    "\n  \n  ",
    "\n  \n  ",
    "\n  \n  ",
    "\n \n  ",
    ...
    "\n   \n   ",
    "\n   \n  ",
    "\n"])), switchColorOff, darken(0.1, switchBackgroundColorOff), function (props) { return css(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n    padding-left: ", ";\n    justify-content: flex-start;\n  "], ["\n    padding-left: ", ";\n    justify-content: flex-start;\n  "])), props.theme.padding.md); }, function (props) {
    return props.isChecked &&
        !props.htmlType && css(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n      color: ", ";\n      background-color: ", ";\n    "], ["\n      color: ", ";\n      background-color: ", ";\n    "])), switchColorOn, props.theme.color.primary);
}, function (props) {
    ...
    return props.htmlType === 'primary' &&
        props.isChecked && css(templateObject_17 || (templateObject_17 = __makeTemplateObject(["\n      color: ", ";\n      background-color: ", ";\n    "], ["\n      color: ", ";\n      background-color: ", ";\n    "])), switchColorOn, props.theme.color.primary);
}, function (props) {
    ...
    return props.isDisabled &&
        props.htmlType &&
        props.isChecked && css(templateObject_22 || (templateObject_22 = __makeTemplateObject(["\n       background-color: ", ";\n     "], ["\n       background-color: ", ";\n     "])), darken(0.1, switchBackgroundColorOff));
}, function (props) {
    return props.isDisabled && css(templateObject_23 || (templateObject_23 = __makeTemplateObject(["\n      background-color: ", ";\n    "], ["\n      background-color: ", ";\n    "])), darken(0.1, switchBackgroundColorOff));
});
export var StyledSwitcherToggler = styled.div(templateObject_32 || (templateObject_32 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  right: ", "px;\n  bottom: 0;\n  width: ", "px;\n  margin: ", ";\n\n  background-color: white;\n  border-radius: 50%;\n  transition: right 0.3s ease;\n  ", "\n  ", "\n  \n   ", "\n   \n   ", "\n   ", "\n   \n   ", "\n   ", "\n"], ["\n  position: absolute;\n  top: 0;\n  right: ", "px;\n  bottom: 0;\n  width: ", "px;\n  margin: ", ";\n\n  background-color: white;\n  border-radius: 50%;\n  transition: right 0.3s ease;\n  ",
    "\n  ",
    "\n  \n   ",
    "\n   \n   ",
    "\n   ",
    ...
    return props.isChecked && css(templateObject_25 || (templateObject_25 = __makeTemplateObject(["\n      right: ", ";\n    "], ["\n      right: ", ";\n    "])), switchWidthNormal);
}, function (props) {
    ...
    return props.size === 'small' &&
        props.isChecked && css(templateObject_27 || (templateObject_27 = __makeTemplateObject(["\n       right: ", ";\n     "], ["\n       right: ", ";\n     "])), switchWidthSmall);
}, function (props) {
    ...
    return props.size === 'medium' && css(templateObject_30 || (templateObject_30 = __makeTemplateObject(["\n       width: ", ";\n       right: ", "px;\n       font-size: 14px;\n     "], ["\n       width: ", ";\n       right: ", "px;\n       font-size: 14px;\n     "])), togglerSizeNormal, switchWidthNormalInt - togglerSizeNormalInt - 2 * marginSM);
}, function (props) {
    return props.size === 'medium' &&
        props.isChecked && css(templateObject_31 || (templateObject_31 = __makeTemplateObject(["\n       right: ", ";\n     "], ["\n       right: ", ";\n     "])), switchWidthNormal);
});
export var StyledSwitcherFalse = styled.div(templateObject_36 || (templateObject_36 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex: 0 0 50%;\n  height: 100%;\n  line-height: 1;\n\n  user-select: none;\n  color: ", ";\n  background-color: ", ";\n  transition: background-color 0.3s ease, color 0.3s ease;\n  ", "\n  ", "\n   \n   ", "\n   \n \n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex: 0 0 50%;\n  height: 100%;\n  line-height: 1;\n\n  user-select: none;\n  color: ", ";\n  background-color: ", ";\n  transition: background-color 0.3s ease, color 0.3s ease;\n  ",
    "\n  ",
    "\n   \n   ",
    "\n   \n \n"])), switchColorOff, darken(0.1, switchBackgroundColorOff), function (props) {
    return props.isChecked && css(templateObject_33 || (templateObject_33 = __makeTemplateObject(["\n      color: ", ";\n    "], ["\n      color: ", ";\n    "])), switchColorOn);
}, function (props) {
    return props.isDisabled && css(templateObject_34 || (templateObject_34 = __makeTemplateObject(["\n      background-color: ", ";\n    "], ["\n      background-color: ", ";\n    "])), darken(0.1, switchBackgroundColorOff));
}, function (props) {
    return props.isDisabled &&
        props.htmlType && css(templateObject_35 || (templateObject_35 = __makeTemplateObject(["\n       background-color: ", ";\n     "], ["\n       background-color: ", ";\n     "])), darken(0.1, switchBackgroundColorOff));
});
