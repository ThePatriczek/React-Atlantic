...
import { StyledSwitcherFalse, StyledSwitcherToggler, StyledSwitcherTrue, StyledSwitcherWrap, StyledSwitchInputHidden, StyledSwitchLabel } from './Switch.style';
export var Switch = function (props) {
    ...
    return (React.createElement(StyledSwitchLabel, { size: size, isChecked: props.isChecked || isChecked, htmlType: type, isDisabled: isDisabled },
        React.createElement(StyledSwitchInputHidden, { onChange: onChange, className: className, checked: props.isChecked || isChecked, disabled: isDisabled }),
        React.createElement(StyledSwitcherWrap, { htmlType: type, isChecked: props.isChecked || isChecked, size: size },
            ...
            React.createElement(StyledSwitcherToggler, { size: size, isChecked: props.isChecked || isChecked, htmlType: type }),
