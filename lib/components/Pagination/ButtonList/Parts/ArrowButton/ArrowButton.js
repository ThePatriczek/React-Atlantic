...
export var ArrowButton = function (props) {
    var isDisabled = props.isDisabled, isSimple = props.isSimple, onClick = props.onClick, unique = props.unique, visible = props.visible;
    ...
    return visible ? (React.createElement("li", { key: unique },
        React.createElement(StyledPaginationButton, { onClick: onClick, isDisabled: isDisabled, isSimple: isSimple },
