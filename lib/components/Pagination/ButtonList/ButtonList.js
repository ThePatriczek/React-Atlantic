...
export var ButtonList = function (props) {
    var count = props.count, isDisabled = props.isDisabled, showDoubleArrowJumper = props.showDoubleArrowJumper, showArrowJumper = props.showArrowJumper, showThreeDots = props.showThreeDots, currentPage = props.currentPage, isSimple = props.isSimple, textLeft = props.textLeft, textRight = props.textRight, onChange = props.onChange;
    ...
    return (React.createElement("ul", null,
        React.createElement(ArrowButton, { onClick: function () { return onDoubleArrowClick(false); }, isDisabled: isDisabled || disabledMinCondition, isSimple: isSimple, unique: -3, visible: showDoubleArrowJumper }),
        React.createElement(ArrowButton, { onClick: function () { return onSingleArrowClick(false); }, isDisabled: isDisabled || disabledMinCondition, isSimple: isSimple, unique: -1, visible: showArrowJumper }),
        array.map(function (item, key) {
            return item === -1 ? (React.createElement(ThreeDots, { text: key > array.length / 2 ? textRight : textLeft, unique: -key - 5, onClick: isDisabled ? undefined : onStepClick, isRight: key > array.length / 2 })) : !isSimple ? (React.createElement("li", { key: item },
                React.createElement(StyledNormalPaginationButton, { onClick: function () { return onChange(item); }, isActive: item === currentPage, isDisabled: isDisabled || item === 0 },
                    React.createElement(ButtonPaginationText, null, item.toString())))) : (React.createElement("li", { key: item },
                React.createElement(StyledSimplePaginationButton, { onClick: function () { return onChange(item); }, isActive: item === currentPage, isDisabled: isDisabled || item === 0, isSimple: true },
                    React.createElement(ButtonPaginationText, null, item.toString()))));
        }),
        React.createElement(ArrowButton, { onClick: function () { return onSingleArrowClick(true); }, isDisabled: isDisabled || disabledMaxCondition, isSimple: isSimple, unique: -2, visible: showArrowJumper }),
        React.createElement(ArrowButton, { onClick: function () { return onDoubleArrowClick(true); }, isDisabled: isDisabled || disabledMaxCondition, isSimple: isSimple, unique: -4, visible: showDoubleArrowJumper })));
};
