...
export var StyledTabsContent = styled.div(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  font-size: ", ";\n  font-family: ", ";\n  padding: ", " ", " ", " ", ";\n \n  ", "\n"], ["\n  font-size: ", ";\n  font-family: ", ";\n  padding: ", " ", " ", " ", ";\n \n  ",
    "\n"])), function (props) { return props.theme.font.size.md; }, function (props) { return props.theme.font.family; }, function (props) { return props.theme.padding.md; }, function (props) { return props.theme.padding.lg; }, function (props) { return props.theme.padding.md; }, function (props) { return props.theme.padding.lg; }, function (props) {
    return props.isBordered && css(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n      border-style: solid;\n      border-color: ", ";\n      border-width: 0 1px 1px 1px;\n      border-radius: 0 0 ", " ", ";\n    "], ["\n      border-style: solid;\n      border-color: ", ";\n      border-width: 0 1px 1px 1px;\n      border-radius: 0 0 ", " ", ";\n    "])), props.theme.color.border, props.theme.radius, props.theme.radius);
});
