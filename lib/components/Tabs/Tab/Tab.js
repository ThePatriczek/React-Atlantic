...
export var Tab = function (props) {
    var value = props.value, label = props.label, isDisabled = props.isDisabled, className = props.className, isActive = props.isActive, isAlternative = props.isAlternative;
    var _a = useRadioGroup(), ctxVal = _a.value, setCtxVal = _a.setValue;
    var isChecked = !!isActive;
    if (ctxVal !== undefined) {
