...
var TabsWithContext = function (props) {
    ...
    var slides = tabs.map(function (tab, index) {
        if (tab.value === value) {
            ...
            var isNextSlide = index - 1 === activeSlide;
            var isPrevSlide = index + 1 === activeSlide;
            return (React.createElement(Carousel.Slide, null, isActiveSlide ? (children) : isNextSlide || isPrevSlide ? (React.createElement("div", null)) : null));
        }
