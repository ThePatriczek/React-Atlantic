...
export var Text = function (props) {
    var children = props.children, isStrong = props.isStrong, isCopyable = props.isCopyable, isEditable = props.isEditable, onEditConfirm = props.onEditConfirm;
    ...
    if (isStrong) {
        return (React.createElement(StyledStrongText, null,
            value,
    ...
    return (React.createElement(StyledText, null,
        value,
        isEditable && (React.createElement(StyledTypoButton, { onClick: onEdit },
            React.createElement(Icon, { name: 'edit' }))),
        isCopyable && (React.createElement(StyledTypoButton, { onClick: onCopy },
