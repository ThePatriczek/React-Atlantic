...
export var Text = function (props) {
    var children = props.children, type = props.type, isCopyable = props.isCopyable, isEditable = props.isEditable, onEditConfirm = props.onEditConfirm, className = props.className, element = props.element;
