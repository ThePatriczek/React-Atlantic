...
export var Text = function (props) {
    var children = props.children, isStrong = props.isStrong, isCopyable = props.isCopyable, isEditable = props.isEditable, onEditConfirm = props.onEditConfirm, className = props.className;
    ...
    if (isStrong) {
        return (React.createElement(StyledStrongText, { className: className },
            value,
            isEditable && (React.createElement(StyledTypoButton, { onClick: onEdit },
                React.createElement(Icon, { name: 'edit' }))),
            isCopyable && (React.createElement(StyledTypoButton, { onClick: onCopy },
                React.createElement(Icon, { name: 'copy' })))));
    }
    return (React.createElement(StyledText, { className: className },
        value,
        isEditable && (React.createElement(StyledTypoButton, { onClick: onEdit },
            React.createElement(Icon, { name: 'edit' }))),
        isCopyable && (React.createElement(StyledTypoButton, { onClick: onCopy },
