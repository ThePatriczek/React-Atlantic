...
export var DatePicker = function (props) {
    var id = props.id, className = props.className, selected = props.selected, placeholder = props.placeholder, onChange = props.onChange, onKeyDown = props.onKeyDown, maxDate = props.maxDate, minDate = props.minDate;
    ...
    return (React.createElement(StyledReactDatePickerContainer, null,
