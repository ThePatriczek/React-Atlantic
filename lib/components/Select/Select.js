...
export var Select = function (props) {
    ...
    return (React.createElement(ReactSelect, { value: val, size: size, isDisabled: isDisabled, options: items, placeholder: placeholder || "Select an option", isSearchable: false, className: className || "", onChange: onChange, isMulti: isMulti, isFullWidth: isFullWidth, defaultValue: defaultValue, blurInputOnSelect: true, autoFocus: autoFocus, components: {
