...
export var Select = function (props) {
    ...
    return (React.createElement(ReactSelect, { value: val, size: size, isDisabled: isDisabled, options: items, placeholder: isAlternative ? "" : placeholder, isSearchable: false, className: className || "", onChange: onChange, isMulti: isMulti, isFullWidth: isFullWidth, defaultValue: defaultValue, blurInputOnSelect: true, autoFocus: autoFocus, components: {
            ...
            Control: function (props) { return (React.createElement(Control, __assign({}, props.innerProps, { isMenuOpened: props.menuIsOpen, isFocused: isFocused, isMulti: props.isMulti, hasValue: props.hasValue, isFullWidth: props.isFullWidth, size: size, isDisabled: props.isDisabled }), props.children)); },
            ...
            SelectContainer: function (_a) {
                ...
                return isAlternative ? (React.createElement(SelectContainerWrapper, __assign({ isMulti: isMulti, hasValue: !!value, onClick: function () { return !isDisabled && setFocused(!isFocused); }, isFullWidth: isFullWidth, size: size, isFocused: isFocused }, innerProps),
                    React.createElement(SelectContainer, __assign({ isFullWidth: isFullWidth, size: size }, innerProps), children),
                    React.createElement("label", null, placeholder))) : (React.createElement(SelectContainer, __assign({ onClick: function () { return !isDisabled && setFocused(!isFocused); }, isFullWidth: isFullWidth, size: size }, innerProps), children));
            },
