...
export var Select = function (props) {
    ...
    return (React.createElement(ReactSelect, { value: value, isDisabled: isDisabled, options: items, placeholder: placeholder || "Select an option", isSearchable: false, className: "" + (className || ""), onChange: onChange, isMulti: isMulti, components: {
