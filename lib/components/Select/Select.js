...
import { ClearIndicator, Control, CrossIcon, DropdownIndicator, IndicatorsContainer, Input, Menu, MenuList, MultiValue, MultiValueLabel, MultiValueRemove, NoOptionsMessage, Placeholder, SelectContainer, SingleValue, ValueContainer } from './Select.style';
...
export var Select = function (props) {
    var children = props.children, isDisabled = props.isDisabled, placeholder = props.placeholder, className = props.className, options = props.options, isMulti = props.isMulti, isFullWidth = props.isFullWidth, size = props.size, defaultValue = props.defaultValue, autoFocus = props.autoFocus;
    ...
    return (React.createElement(ReactSelect, { value: val, isDisabled: isDisabled, options: items, placeholder: placeholder || "Select an option", isSearchable: false, className: className || "", onChange: onChange, isMulti: isMulti, blurInputOnSelect: true, autoFocus: autoFocus, components: {
