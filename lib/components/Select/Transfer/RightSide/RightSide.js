...
import { StyledChosenHeader, StyledDeleteAllButton, StyledDeleteOneButton, StyledDeleteOneIcon, StyledTransferDeleteAllButtonIcon, StyledTransferSpan } from './style';
export var RightSide = function (props) {
    var _a;
    ...
    return (React.createElement(StyledTransferSide, { direction: direction, isHalfOpen: isHalfOpen, isOpen: isOpen, isFullWidth: isFullWidth, size: size, side: 'right' },
        React.createElement(StyledChosenHeader, { size: size },
            ...
            React.createElement(StyledDeleteAllButton, { isTransparent: true, globalSize: size, size: 'small', type: 'error', onClick: function () {
                    uncheckAll();
                } },
