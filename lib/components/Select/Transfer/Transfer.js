...
export var Transfer = function (props) {
    var value = props.value, defaultValue = props.defaultValue, placeholder = props.placeholder, options = props.options, isDisabled = props.isDisabled, children = props.children, closeText = props.closeText, submitText = props.submitText, deleteAllText = props.deleteAllText, notFoundComponent = props.notFoundComponent, isAlternative = props.isAlternative, size = props.size, chosenComponent = props.chosenComponent, isFullWidth = props.isFullWidth, direction = props.direction;
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(StyledTransfer, { size: size, ref: ref, isFullWidth: isFullWidth, isHalfOpen: isHalfOpen, isOpen: isOpen, isFocused: isFocused, isDisabled: isDisabled, direction: direction },
            React.createElement(StyledTransferForm, { onSubmit: formSubmit, direction: direction },
