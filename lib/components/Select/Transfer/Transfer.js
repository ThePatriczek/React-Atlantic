...
export var Transfer = function (props) {
    var value = props.value, defaultValue = props.defaultValue, placeholder = props.placeholder, options = props.options, isDisabled = props.isDisabled, children = props.children, closeText = props.closeText, submitText = props.submitText, deleteAllText = props.deleteAllText, notFoundComponent = props.notFoundComponent, size = props.size, chosenComponent = props.chosenComponent, isFullWidth = props.isFullWidth, direction = props.direction;
    ...
    return (React.createElement(StyledTransferContainer, { placeholder: placeholder, deleteAllText: deleteAllText, closeText: closeText, submitText: submitText, isDisabled: isDisabled, options: options, notFoundComponent: notFoundComponent, size: size, isFullWidth: isFullWidth, direction: direction },
