...
export var StyledButton = styled(DefaultButton)(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  @-webkit-keyframes focusAnimation {\n    0%   { opacity: 0; }\n    25% { opacity: .5; }\n    50% { opacity: 1; }\n    75% { opacity: .5; }\n    100% { opacity: 0; }\n  }\n\n  ", "\n\n  ", "\n\n  ", "\n  \n  ", "\n    \n  ", "\n    \n  ", "\n    \n  ", "\n"], ["\n  @-webkit-keyframes focusAnimation {\n    0%   { opacity: 0; }\n    25% { opacity: .5; }\n    50% { opacity: 1; }\n    75% { opacity: .5; }\n    100% { opacity: 0; }\n  }\n\n  ",
    ...
    return !props.disabled &&
        ...
        props.animationRunning && css(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n      &:after {\n        content: '';\n        position: absolute;\n        top: -3px;\n        left: -3px;\n        right: -3px;\n        bottom: -3px;\n\n        z-index: -1;\n        border-radius: ", ";\n        background: ", ";\n        animation: focusAnimation 0.4s ease-in-out;\n      }\n    "], ["\n      &:after {\n        content: '';\n        position: absolute;\n        top: -3px;\n        left: -3px;\n        right: -3px;\n        bottom: -3px;\n\n        z-index: -1;\n        border-radius: ",
        ";\n        background: ", ";\n        animation: focusAnimation 0.4s ease-in-out;\n      }\n    "])), props.isRound
        ? props.theme.rounded
        : props.theme.radius, props.theme.color.default);
}, function (props) {
    var color = "black";
...
export var StyledTypoButton = styled(DefaultButton)(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n  padding: 0 ", ";\n  height: auto;\n  margin: 0;\n\n  background: transparent;\n  color: ", ";\n  border: 0;\n  box-shadow: none;\n"], ["\n  padding: 0 ", ";\n  height: auto;\n  margin: 0;\n\n  background: transparent;\n  color: ", ";\n  border: 0;\n  box-shadow: none;\n"])), function (props) { return props.theme.padding.sm; }, function (props) { return props.theme.color.primary; });
