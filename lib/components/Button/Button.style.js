...
export var focusAnimation = keyframes(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    0%    { opacity: 0; }\n    25%   { opacity: .5; }\n    50%   { opacity: 1; }\n    75%   { opacity: .5; }\n    100%  { opacity: 0; }\n  "], ["\n    0%    { opacity: 0; }\n    25%   { opacity: .5; }\n    50%   { opacity: 1; }\n    75%   { opacity: .5; }\n    100%  { opacity: 0; }\n  "])));
...
export var StyledButton = styled(DefaultButton)(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n  ", "\n\n  ", "\n\n  ", "\n  \n  ", "\n    \n  ", "\n    \n  ", "\n    \n  ", "\n"], ["\n  ",
    ...
    return css(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n      background-color: ", ";\n      color: ", ";\n      border: 1px ", " ", ";\n\n      &:hover {\n        background-color: ", ";\n        ", "\n      }\n    "], ["\n      background-color: ", ";\n      color: ", ";\n      border: 1px ", " ", ";\n\n      &:hover {\n        background-color: ", ";\n        ",
        "\n      }\n    "])), bgColor, color, borderType, borderColor, hoverBgColor, props.styleType === 'transparent' && css(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n            border: 1px ", " ", ";\n          "], ["\n            border: 1px ", " ", ";\n          "])), borderType, color));
}, function (props) {
