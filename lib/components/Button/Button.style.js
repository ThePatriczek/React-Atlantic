...
var defaultButton = styled.button(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  padding: 0 ", ";\n  height: 34px;\n  line-height: 1.5;\n  position: relative;\n  display: inline-block;\n  font-weight: 400;\n  white-space: nowrap;\n  text-align: center;\n  background-image: none;\n  color: black;\n  border-radius: ", ";\n  outline: 0;\n  cursor: pointer;\n  font-size: 14px;\n  user-select: none;\n  touch-action: manipulation;\n  transition: background-color 0.1s ease;\n  box-shadow: 0 0 4px rgba(0, 0, 0, 0.06);\n  border: 1px solid ", ";\n"], ["\n  padding: 0 ", ";\n  height: 34px;\n  line-height: 1.5;\n  position: relative;\n  display: inline-block;\n  font-weight: 400;\n  white-space: nowrap;\n  text-align: center;\n  background-image: none;\n  color: black;\n  border-radius: ", ";\n  outline: 0;\n  cursor: pointer;\n  font-size: 14px;\n  user-select: none;\n  touch-action: manipulation;\n  transition: background-color 0.1s ease;\n  box-shadow: 0 0 4px rgba(0, 0, 0, 0.06);\n  border: 1px solid ", ";\n"])), function (props) { return props.theme.padding.md; }, function (props) { return props.theme.radius; }, function (props) { return darken(0.1, props.theme.color.default); });
export var StyledButton = styled(defaultButton)(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  @-webkit-keyframes focusAnimation {\n    0%   { opacity: 0; }\n    50% { opacity: 1; }\n    100% { opacity: 0; }\n  }\n\n  ", "\n\n  ", "\n\n  ", "\n  \n  ", "\n    \n  ", "\n    \n  ", "\n    \n  ", "\n  \n    > span, > i{\n    height: 18px;\n    line-height: 18px;\n\n    display: inline-block;\n    vertical-align: 1px;\n    pointer-events: none;\n    transition: margin-left .3s cubic-bezier(.645, .045, .355, 1);\n  }\n\n  i+span,span+i{\n    margin-left: ", ";\n  }\n\n  i{\n    text-rendering: optimizeLegibility;\n    -webkit-font-smoothing: antialiased;\n    -moz-osx-font-smoothing: grayscale;\n  }\n"], ["\n  @-webkit-keyframes focusAnimation {\n    0%   { opacity: 0; }\n    50% { opacity: 1; }\n    100% { opacity: 0; }\n  }\n\n  ",
    ...
    return css(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n      background-color: ", ";\n      color: ", ";\n      border: 1px ", " ", ";\n\n      &:hover {\n        background-color: ", ";\n        ", "\n      }\n    "], ["\n      background-color: ", ";\n      color: ", ";\n      border: 1px ", " ", ";\n\n      &:hover {\n        background-color: ", ";\n        ",
        "\n      }\n    "])), bgColor, color, borderType, borderColor, hoverBgColor, props.type === 'transparent' && css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n            border: 1px ", " ", ";\n          "], ["\n            border: 1px ", " ", ";\n          "])), borderType, color));
}, function (props) {
    ...
    return props.isRounded && css(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n      border-radius: ", ";\n    "], ["\n      border-radius: ", ";\n    "])), props.theme.rounded);
}, function (props) {
    return props.size === 'small' && css(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n      padding: 0 ", ";\n      height: 26px;\n      font-size: 12px;\n\n      > span,\n      > i {\n        vertical-align: -3px;\n      }\n\n      .icon + span,\n      span + .icon {\n        margin-left: ", ";\n      }\n    "], ["\n      padding: 0 ", ";\n      height: 26px;\n      font-size: 12px;\n\n      > span,\n      > i {\n        vertical-align: -3px;\n      }\n\n      .icon + span,\n      span + .icon {\n        margin-left: ", ";\n      }\n    "])), props.theme.padding.sm, props.theme.margin.sm);
}, function (props) {
    return props.size === 'large' && css(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n      padding: 0 ", ";\n      height: 40px;\n      font-size: 16px;\n\n      .icon + span,\n      span + .icon {\n        margin-left: ", ";\n      }\n    "], ["\n      padding: 0 ", ";\n      height: 40px;\n      font-size: 16px;\n\n      .icon + span,\n      span + .icon {\n        margin-left: ", ";\n      }\n    "])), props.theme.padding.lg, props.theme.margin.lg);
}, function (props) {
    return props.isFullWide && css(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n      width: 100%;\n    "], ["\n      width: 100%;\n    "])));
