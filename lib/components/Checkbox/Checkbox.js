...
export var Checkbox = function (props) {
    ...
    return (React.createElement(StyledCheckboxLabel, { onClick: onClick, isChecked: props.isChecked || isChecked, isDisabled: isDisabled, className: className },
        ...
        React.createElement(StyledCheckboxInputShown, { isDisabled: isDisabled }, trail.map(function (style, index) {
            var _a, _b;
            return (React.createElement(StyledCheckboxMark, { key: index, style: style, isDisabled: isDisabled, isChecked: props.isChecked || isChecked, isPartiallyChecked: isPartiallyChecked },
                React.createElement(StyledCheckboxIcon, { isDisabled: isDisabled, isChecked: props.isChecked || isChecked, isPartiallyChecked: isPartiallyChecked },
                    React.createElement(CheckSimple, { x: (_b = (_a = springProps) === null || _a === void 0 ? void 0 : _a.x) === null || _b === void 0 ? void 0 : _b.interpolate(function (x) { return x; }) }))));
        })),
