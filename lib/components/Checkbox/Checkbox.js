...
export var Checkbox = function (props) {
    var isPartiallyChecked = props.isPartiallyChecked, isDefaultChecked = props.isDefaultChecked, position = props.position, isDisabled = props.isDisabled, className = props.className, children = props.children, handlersWithEvent = props.handlersWithEvent, id = props.id;
    var _a = useClickChange({
        ...
        handlersWithEvent: handlersWithEvent
    ...
    return (React.createElement(StyledCheckboxLabel, { onClick: function (e) { return onChangeClick(e, isPartiallyChecked); }, isChecked: props.isChecked || isChecked, isDisabled: isDisabled, className: className, htmlFor: id },
        position === 'right' && (React.createElement(StyledCheckboxSpan, { position: position, isDisabled: isDisabled }, children)),
        React.createElement(HiddenCheckbox, { id: id, checked: props.isChecked || isChecked, disabled: isDisabled }),
