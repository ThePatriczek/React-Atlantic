...
export var Checkbox = function (props) {
    var isPartiallyChecked = props.isPartiallyChecked, isDefaultChecked = props.isDefaultChecked, position = props.position, isDisabled = props.isDisabled, className = props.className, children = props.children, handlersWithEvent = props.handlersWithEvent;
