...
export var StyledCheckboxInputHidden = styled.input.attrs({
    type: 'checkbox'
})(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  opacity: 0;\n  width: 0;\n  height: 0;\n  margin: 0;\n"], ["\n  opacity: 0;\n  width: 0;\n  height: 0;\n  margin: 0;\n"])));
export var StyledCheckboxInputShown = styled.div.attrs({ className: "atlantic--checkbox" })(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  padding: ", "px;\n  background: white;\n  border-radius: ", "px;\n  border: 1px solid ", ";\n\n  ", "\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  padding: ", "px;\n  background: white;\n  border-radius: ", "px;\n  border: 1px solid ", ";\n\n  ",
