...
export var Input = function (props) {
    ...
    var AlternativeComponent = (React.createElement(StyledInputWrapperAlt, { size: size, isFocused: transferFocus, isLeftComponent: !!iconLeft, isRightComponent: !!(iconRight || isLoading), hasValue: !!val, isDisabled: isDisabled, onClick: function () {
            if (ref.current) {
                ref.current.focus();
            }
