...
export var Input = function (props) {
    ...
    var Component = (React.createElement(StyledInput, { id: id, value: props.value !== undefined ? props.value : value, onChange: onChange, disabled: isDisabled, placeholder: placeholder, onKeyDown: onKeyDown, autoFocus: autoFocus, onBlur: onBlur, onFocus: onFocus, ref: ref, size: size, autoComplete: autoComplete, type: htmlType }));
