...
export var Input = function (props) {
    ...
    var Component = (React.createElement(StyledInput, { id: id, value: value, onChange: onChange, disabled: isDisabled, placeholder: isAlternative ? "" : placeholder, onKeyDown: onKeyDown, autoFocus: autoFocus, onBlur: onBlur, onFocus: onFocus, ref: ref, size: size, autoComplete: autoComplete, type: htmlType, isFullWidth: isFullWidth }));
    var AlternativeComponent = (React.createElement(StyledInputWrapperAlt, { size: size, isFocused: transferFocus, iconLeft: !!iconLeft, iconRight: !!(iconRight || isLoading), hasValue: !!value, isDisabled: isDisabled, onClick: function () {
            if (ref.current) {
                ref.current.focus();
            }
