...
export var StyledInputWrapperAlt = styled.span(templateObject_28 || (templateObject_28 = __makeTemplateObject(["\n  font-family: ", ";\n  display: inline-block;\n  position: relative;\n  margin-top: -", ";\n  padding-top: ", ";\n\n  ", "\n\n  label { \n    ", "\n    ", "\n    ", "\n    \n    \n    position: absolute;\n    top: 0;\n    left: 0;\n    right: 0;\n    padding: 0 ", ";\n\n    color: ", ";\n    cursor: text;\n\n    -webkit-transition: color 0.2s ease-out, -webkit-transform 0.2s ease-out;\n    transition: color 0.2s ease-out, -webkit-transform 0.2s ease-out;\n    transition: transform 0.2s ease-out, color 0.2s ease-out;\n    transition: transform 0.2s ease-out, color 0.2s ease-out,\n      -webkit-transform 0.2s ease-out;\n    -webkit-transform-origin: 0% 100%;\n    transform-origin: 0% 100%;\n    -webkit-transform: translateY(12px);\n    transform: translateY(12px);\n\n    ", "\n  }\n\n  ", "\n\n  ", "\n  \n    \n   ", " \n"], ["\n  font-family: ", ";\n  display: inline-block;\n  position: relative;\n  margin-top: -", ";\n  padding-top: ", ";\n\n  ",
    "\n\n  label { \n    ",
    "\n    ",
    "\n    ",
    "\n    \n    \n    position: absolute;\n    top: 0;\n    left: 0;\n    right: 0;\n    padding: 0 ", ";\n\n    color: ", ";\n    cursor: text;\n\n    -webkit-transition: color 0.2s ease-out, -webkit-transform 0.2s ease-out;\n    transition: color 0.2s ease-out, -webkit-transform 0.2s ease-out;\n    transition: transform 0.2s ease-out, color 0.2s ease-out;\n    transition: transform 0.2s ease-out, color 0.2s ease-out,\n      -webkit-transform 0.2s ease-out;\n    -webkit-transform-origin: 0% 100%;\n    transform-origin: 0% 100%;\n    -webkit-transform: translateY(12px);\n    transform: translateY(12px);\n\n    ",
    ...
    return (props.isFocused || props.hasValue || props.isDisabled) && css(templateObject_22 || (templateObject_22 = __makeTemplateObject(["\n        height: ", ";\n        line-height: ", ";\n        left: 5px;\n        right: auto;\n\n        background: white;\n        color: ", ";\n\n        -webkit-transform: translateY(-14px) scale(0.8);\n        transform: translateY(0px) scale(0.8);\n        -webkit-transform-origin: 0 0;\n        transform-origin: 0 0;\n      "], ["\n        height: ", ";\n        line-height: ", ";\n        left: 5px;\n        right: auto;\n\n        background: white;\n        color: ", ";\n\n        -webkit-transform: translateY(-14px) scale(0.8);\n        transform: translateY(0px) scale(0.8);\n        -webkit-transform-origin: 0 0;\n        transform-origin: 0 0;\n      "])), props.theme.height.sm, props.theme.height.sm, props.theme.color.primary);
}, function (props) {
    return props.iconLeft && css(templateObject_24 || (templateObject_24 = __makeTemplateObject(["\n      input {\n        padding-right: ", ";\n      }\n\n      label {\n        transform: translateY(-10px) scale(0.8);\n        ", "\n      }\n    "], ["\n      input {\n        padding-right: ", ";\n      }\n\n      label {\n        transform: translateY(-10px) scale(0.8);\n        ",
        "\n      }\n    "])), props.theme.padding.md, !(props.isFocused || props.hasValue) && css(templateObject_23 || (templateObject_23 = __makeTemplateObject(["\n            padding-left: 30px;\n            transform: translateY(2px);\n          "], ["\n            padding-left: 30px;\n            transform: translateY(2px);\n          "]))));
}, function (props) {
    return props.iconRight && css(templateObject_26 || (templateObject_26 = __makeTemplateObject(["\n      input {\n        padding-left: ", ";\n      }\n\n      label {\n        transform: translateY(-10px) scale(0.8);\n\n        ", "\n      }\n    "], ["\n      input {\n        padding-left: ", ";\n      }\n\n      label {\n        transform: translateY(-10px) scale(0.8);\n\n        ",
        "\n      }\n    "])), props.theme.padding.md, !(props.isFocused || props.hasValue) && css(templateObject_25 || (templateObject_25 = __makeTemplateObject(["\n            padding-right: 30px;\n            transform: translateY(2px);\n          "], ["\n            padding-right: 30px;\n            transform: translateY(2px);\n          "]))));
}, function (props) {
    return props.isFullWidth && css(templateObject_27 || (templateObject_27 = __makeTemplateObject(["\n       width: 100%;\n     "], ["\n       width: 100%;\n     "])));
});
