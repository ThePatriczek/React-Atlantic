...
export var StyledInputWrapper = styled.span(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  font-family: ", ";\n  position: relative;\n  display: inline-block;\n\n  ", "\n\n  ", "\n\n  ", "\n\n  i {\n    display: flex;\n    ", ";\n    align-items: center;\n    position: absolute;\n    width: 14px;\n    \n    ", ";\n        \n    ", ";    \n    \n    ", ";\n    \n    top: 0;\n    bottom: 0;\n    z-index: 2;\n    line-height: 0;\n\n    text-rendering: optimizeLegibility;\n    -webkit-font-smoothing: antialiased;\n    -moz-osx-font-smoothing: grayscale;\n  }\n\n  ", "\n"], ["\n  font-family: ", ";\n  position: relative;\n  display: inline-block;\n\n  ",
    "\n\n  ",
    "\n\n  ",
    "\n\n  i {\n    display: flex;\n    ",
    ";\n    align-items: center;\n    position: absolute;\n    width: 14px;\n    \n    ",
...
export var StyledInput = styled.input(templateObject_16 || (templateObject_16 = __makeTemplateObject(["\n  font-family: ", ";\n  padding: ", " ", ";\n  height: ", ";\n  margin: 0;\n\n  position: relative;\n  display: inline-block;\n\n  font-size: ", ";\n  font-weight: 400;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n  user-select: none;\n  -webkit-appearance: textfield;\n  touch-action: manipulation;\n\n  background-color: ", ";\n  color: ", ";\n  border-radius: ", ";\n  outline: 0;\n  list-style: none;\n\n  -webkit-box-sizing: border-box;\n  -moz-box-sizing: border-box;\n  box-sizing: border-box;\n\n  border: 1px solid ", ";\n\n  ::placeholder {\n    color: ", ";\n  }\n\n  :focus {\n    border-color: ", ";\n    outline-offset: -2px;\n    box-shadow: 0 0 0 2px rgba(24, 144, 255, 0.3);\n  }\n\n  ", "\n\n  ", " \n\n  ", " \n  \n    ", " \n\n\n    ", " \n"], ["\n  font-family: ", ";\n  padding: ", " ",
    ";\n  height: ", ";\n  margin: 0;\n\n  position: relative;\n  display: inline-block;\n\n  font-size: ", ";\n  font-weight: 400;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n  user-select: none;\n  -webkit-appearance: textfield;\n  touch-action: manipulation;\n\n  background-color: ", ";\n  color: ", ";\n  border-radius: ", ";\n  outline: 0;\n  list-style: none;\n\n  -webkit-box-sizing: border-box;\n  -moz-box-sizing: border-box;\n  box-sizing: border-box;\n\n  border: 1px solid ", ";\n\n  ::placeholder {\n    color: ", ";\n  }\n\n  :focus {\n    border-color: ", ";\n    outline-offset: -2px;\n    box-shadow: 0 0 0 2px rgba(24, 144, 255, 0.3);\n  }\n\n  ",
    "\n\n  ",
    " \n\n  ",
    " \n  \n    ",
    ...
    return props.isFullWidth && css(templateObject_15 || (templateObject_15 = __makeTemplateObject(["\n        width: 100%;\n      "], ["\n        width: 100%;\n      "])));
});
export var StyledInputWrapperAlt = styled.span(templateObject_26 || (templateObject_26 = __makeTemplateObject(["\n  font-family: ", ";\n  display: inline-block;\n  position: relative;\n  padding-top: ", ";\n\n  ", "\n\n  label { \n    ", "\n    ", "\n    ", "\n    \n    \n    position: absolute;\n    top: 0;\n    left: 0;\n    right: 0;\n    padding: 0 ", ";\n\n    color: ", ";\n    cursor: text;\n\n    -webkit-transition: color 0.2s ease-out, -webkit-transform 0.2s ease-out;\n    transition: color 0.2s ease-out, -webkit-transform 0.2s ease-out;\n    transition: transform 0.2s ease-out, color 0.2s ease-out;\n    transition: transform 0.2s ease-out, color 0.2s ease-out,\n      -webkit-transform 0.2s ease-out;\n    -webkit-transform-origin: 0% 100%;\n    transform-origin: 0% 100%;\n    -webkit-transform: translateY(12px);\n    transform: translateY(12px);\n\n    ", "\n  }\n\n  ", "\n\n  ", "\n"], ["\n  font-family: ", ";\n  display: inline-block;\n  position: relative;\n  padding-top: ", ";\n\n  ",
    "\n\n  label { \n    ",
    "\n    ",
    "\n    ",
    "\n    \n    \n    position: absolute;\n    top: 0;\n    left: 0;\n    right: 0;\n    padding: 0 ", ";\n\n    color: ", ";\n    cursor: text;\n\n    -webkit-transition: color 0.2s ease-out, -webkit-transform 0.2s ease-out;\n    transition: color 0.2s ease-out, -webkit-transform 0.2s ease-out;\n    transition: transform 0.2s ease-out, color 0.2s ease-out;\n    transition: transform 0.2s ease-out, color 0.2s ease-out,\n      -webkit-transform 0.2s ease-out;\n    -webkit-transform-origin: 0% 100%;\n    transform-origin: 0% 100%;\n    -webkit-transform: translateY(12px);\n    transform: translateY(12px);\n\n    ",
    ...
    return !props.isDisabled && css(templateObject_17 || (templateObject_17 = __makeTemplateObject(["\n      :hover {\n        i {\n          color: ", ";\n        }\n        input {\n          border-color: ", ";\n        }\n      }\n    "], ["\n      :hover {\n        i {\n          color: ", ";\n        }\n        input {\n          border-color: ", ";\n        }\n      }\n    "])), props.theme.color.primary, props.theme.color.primary);
}, function (props) {
    ...
    return (props.isFocused || props.hasValue || props.isDisabled) && css(templateObject_21 || (templateObject_21 = __makeTemplateObject(["\n        height: ", ";\n        line-height: ", ";\n        left: 5px;\n        right: auto;\n\n        background: white;\n        color: ", ";\n\n        -webkit-transform: translateY(-14px) scale(0.8);\n        transform: translateY(0px) scale(0.8);\n        -webkit-transform-origin: 0 0;\n        transform-origin: 0 0;\n      "], ["\n        height: ", ";\n        line-height: ", ";\n        left: 5px;\n        right: auto;\n\n        background: white;\n        color: ", ";\n\n        -webkit-transform: translateY(-14px) scale(0.8);\n        transform: translateY(0px) scale(0.8);\n        -webkit-transform-origin: 0 0;\n        transform-origin: 0 0;\n      "])), props.theme.height.sm, props.theme.height.sm, props.theme.color.primary);
}, function (props) {
    return props.iconLeft && css(templateObject_23 || (templateObject_23 = __makeTemplateObject(["\n      input {\n        padding-right: ", ";\n      }\n\n      label {\n        transform: translateY(-10px) scale(0.8);\n        ", "\n      }\n    "], ["\n      input {\n        padding-right: ", ";\n      }\n\n      label {\n        transform: translateY(-10px) scale(0.8);\n        ",
        "\n      }\n    "])), props.theme.padding.md, !(props.isFocused || props.hasValue) && css(templateObject_22 || (templateObject_22 = __makeTemplateObject(["\n            padding-left: 30px;\n            transform: translateY(2px);\n          "], ["\n            padding-left: 30px;\n            transform: translateY(2px);\n          "]))));
}, function (props) {
    return props.iconRight && css(templateObject_25 || (templateObject_25 = __makeTemplateObject(["\n      input {\n        padding-left: ", ";\n      }\n\n      label {\n        transform: translateY(-10px) scale(0.8);\n\n        ", "\n      }\n    "], ["\n      input {\n        padding-left: ", ";\n      }\n\n      label {\n        transform: translateY(-10px) scale(0.8);\n\n        ",
